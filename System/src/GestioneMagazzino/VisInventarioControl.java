...
public class VisInventarioControl {
    ...
    private void visualizzaInventario(){
        ...
        ActionListener visLstnr = e -> {
            ...
            ArrayList<Farmaco> farmaci = db.getInventario(u.getID_Farmacia());
            ...
            if (farmaci != null){
                ...
                JOptionPane.showMessageDialog(inventario, "Non sono presenti farmaci in magazzino", "Nessun farmaco", JOptionPane.INFORMATION_MESSAGE);
                inventario.dispose();
            }
        };
